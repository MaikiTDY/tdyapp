...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    //custom attrs
    private int tabTextSelectedSize = 12;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabTextSelectedSize = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsTextSelectedSize,tabTextSelectedSize);
